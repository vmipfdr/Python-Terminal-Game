...
# @app.route("/card/<id>", methods=["GET", "PUT", "DELETE"])
# def endpoint(id=None);
#     if request.method == "GET":
#         if id:
#             return jsonify(model_to_dict(Card.get(Card.id == id)))
#         else:
#             cardList = {}
#             for card in Card.select():
#                 cardList.append(model_to_dict(card))
...
#         new_card = dict_to_modelCard, request.get_json())
#         new_card.save()
